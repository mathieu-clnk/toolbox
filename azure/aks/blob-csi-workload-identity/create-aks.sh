...
vnet_name="vnt-demo-1857"
subnet="default"
route_table="rte-demo-1857"
...
create_cluster_managed_identity() {
  ...
  #This managed identity is only used by the cluster to create and manage resources
  # related to AKS such as the provisioning of a load balancer or a disk
  # This identity is not used in the deployment sample to access to the Storage container.
